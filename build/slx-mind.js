		...
		jQuery( document ).on( "mousedown", function( event ) {
			...
			if ( event.button === 0 ) { 
				...
				switch ( arEventtargetid[0] ) {
					...
					case "_4": // ensures some amount of space of the topbar is showing
